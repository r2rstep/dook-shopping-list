...
def test_create_shopping_list_for_single_recipe__some_ingredients_missing():
    ingredients_in_fridge = [models.IngredientInFridge(name='banana', quantity=4, unit=models.QuantityUnits.units),
    ...
    recipe = models.Recipe(ingredients=[models.Ingredient(name='salad', quantity=1, unit=models.QuantityUnits.units),
